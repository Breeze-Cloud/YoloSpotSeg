...
from ultralytics.yolo.utils import DEFAULT_CFG, LOGGER, RANK, SETTINGS, TQDM_BAR_FORMAT, callbacks, colorstr, emojis, ops
...
class BaseValidator:
    ...
    #     saveName = os.environ["saveName"]
    #
    #     imgF1 = self.per_image_stats
    #
    #     imgIDList = []
    #     F1List = []
    ...
    #         a = [x for x in chunk if x is not None]
    #         avg = sum(a) / len(a)
    #         averages.append(avg)
    #
