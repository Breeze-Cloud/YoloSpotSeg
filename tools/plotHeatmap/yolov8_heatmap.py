...
class yolov8_heatmap:
    ...
    def process(self, img_path, save_path):
        ...
        if self.show_box:
            for data in pred:
                ...
                cam_image = self.draw_detections(data[:4], self.colors[0],
                                                 f'{self.model_names[0]} {float(data[4]):.2f}', cam_image)
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/noaddup.png')


def get_params():
    params = {
        'weight': '/home/pointseg/Yolov8/runs/segment/train68/weights/best.pt',  # 现在只需要指定权重即可,不需要指定cfg  # /home/pointseg/Yolov8/runs/segment/receptorSpl/train15/weights/best.pt
        'device': 'cuda:0',
        'method': 'XGradCAM',
...
if __name__ == '__main__':
    ...
    model(r'/home/pointseg/datasets/deepblink/receptorSpl/images/test/0.tif', '/home/pointseg/Yolov8/tools/plotHeatmap/addupsample')
